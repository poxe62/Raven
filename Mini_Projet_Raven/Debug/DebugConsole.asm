; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.50727.1 
	...
	TITLE	D:\Git\GitHubProject\Mini_Projet_Raven_IA\Common\Debug\DebugConsole.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
CONST	SEGMENT
$SG145409 DB	'Error!', 00H
	ORG $+1
$SG145410 DB	'CreateWindowEx Failed!', 00H
	ORG $+1
_Pi	DQ	0400921f9f01b866er		; 3.14159
$SG145398 DB	'DebugLog.txt', 00H
	ORG $+3
$SG145402 DB	'Debug', 00H
	ORG $+2
$SG145404 DB	'Error', 00H
	ORG $+2
$SG145405 DB	'Registration of Debug Console Failed!', 00H
	ORG $+2
$SG145406 DB	'Debug Console', 00H
	ORG $+2
$SG145407 DB	'Debug', 00H
CONST	ENDS
...
text$yd	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\git\githubproject\mini_projet_raven_ia\common\debug\debugconsole.cpp
...
; 274  : 						           "Debug",
	...
	mov	DWORD PTR _wDebugConsole$[ebp+40], OFFSET $SG145402
...
; 96   :       switch (LOWORD (wparam))
	...
	ja	SHORT $LN26@DebugWindo
	mov	ecx, DWORD PTR tv161[ebp]
	jmp	DWORD PTR $LN59@DebugWindo[ecx*4]
$LN25@DebugWindo:
...
; 247  : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN58@DebugWindo
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	mov	ecx, DWORD PTR __$EHRec$[ebp]
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\microsoft visual studio\vc\include\fstream
...
; 1096 : 		{	// open a C stream with specified mode
...
; 1097 : 		if (_Filebuffer.open(_Filename, _Mode | ios_base::out, _Prot) == 0)
...
; 1100 : 			_Myios::clear();	// added with C++0X
...
; 541  : 		ios_base::iostate _State = ios_base::goodbit;

	mov	DWORD PTR __State$[ebp], 0

; 542  : 		const sentry _Ok(*this);
...
; 547  : 			{	// state okay, insert character
; 548  : 			_TRY_IO_BEGIN

	mov	BYTE PTR __$EHRec$[ebp+12], 1

; 549  : 			if (_Traits::eq_int_type(_Traits::eof(),
; 550  : 				_Myios::rdbuf()->sputc(_Ch)))
...
; 202  : 		{	// call basic_ostream manipulator
...
; 1020 : 	{	// insert newline and flush byte stream
