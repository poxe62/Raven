; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.50727.1 
	...
	TITLE	D:\Git\GitHubProject\Mini_Projet_Raven_IA\Common\fuzzy\FuzzySet_RightShoulder.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\git\githubproject\mini_projet_raven_ia\common\fuzzy\fuzzyset_rightshoulder.cpp
_TEXT	SEGMENT
tv181 = -20						; size = 8
_grad$1 = -12						; size = 8
_this$ = -4						; size = 4
...
; 13   :   }
; 14   :   
; 15   :   //find DOM if left of center
; 16   :   else if ( (val <= m_dPeakPoint) && (val > (m_dPeakPoint - m_dLeftOffset)) )

	mov	edx, DWORD PTR _this$[ebp]
	movsd	xmm0, QWORD PTR [edx+24]
	comisd	xmm0, QWORD PTR _val$[ebp]
	jb	SHORT $LN4@CalculateD
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	movsd	xmm0, QWORD PTR [eax+24]
...
; 17   :   {
; 18   :     double grad = 1.0 / m_dLeftOffset;
...
; 19   : 
; 20   :     return grad * (val - (m_dPeakPoint - m_dLeftOffset));
...
; 21   :   }
; 22   :   //find DOM if right of center and less than center + right offset
; 23   :   else if ( (val > m_dPeakPoint) && (val <= m_dPeakPoint+m_dRightOffset) )

	mov	edx, DWORD PTR _this$[ebp]
	movsd	xmm0, QWORD PTR _val$[ebp]
	comisd	xmm0, QWORD PTR [edx+24]
	jbe	SHORT $LN2@CalculateD
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	movsd	xmm0, QWORD PTR [eax+24]
