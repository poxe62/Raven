; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.50727.1 
	...
	TITLE	D:\Git\GitHubProject\Mini_Projet_Raven_IA\Raven\goals\GetHealthGoal_Evaluator.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_1HM@PECBDNPB@?$AAD?$AA?3?$AA?2?$AAG?$AAi?$AAt?$AA?2?$AAG?$AAi?$AAt?$AAH?$AAu?$AAb?$AAP?$AAr?$AAo?$AAj?$AAe?$AAc?$AAt?$AA?2?$AAM?$AAi?$AAn?$AAi?$AA_?$AAP?$AAr?$AAo?$AAj?$AAe?$AAt@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_1HM@PECBDNPB@?$AAD?$AA?3?$AA?2?$AAG?$AAi?$AAt?$AA?2?$AAG?$AAi?$AAt?$AAH?$AAu?$AAb?$AAP?$AAr?$AAo?$AAj?$AAe?$AAc?$AAt?$AA?2?$AAM?$AAi?$AAn?$AAi?$AA_?$AAP?$AAr?$AAo?$AAj?$AAe?$AAt@
CONST	SEGMENT
??_C@_1HM@PECBDNPB@?$AAD?$AA?3?$AA?2?$AAG?$AAi?$AAt?$AA?2?$AAG?$AAi?$AAt?$AAH?$AAu?$AAb?$AAP?$AAr?$AAo?$AAj?$AAe?$AAc?$AAt?$AA?2?$AAM?$AAi?$AAn?$AAi?$AA_?$AAP?$AAr?$AAo?$AAj?$AAe?$AAt@ DB 'D'
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\git\githubproject\mini_projet_raven_ia\raven\goals\gethealthgoal_evaluator.cpp
_TEXT	SEGMENT
tv171 = -300						; size = 4
tv177 = -296						; size = 4
tv169 = -292						; size = 4
...
; 57   :   gdi->TextAtPos(Position, "H: " + ttos(CalculateDesirability(pBot), 2));
...
; 59   :   
; 60   :   std::string s = ttos(1-Raven_Feature::Health(pBot)) + ", " + ttos(Raven_Feature::DistanceToItem(pBot, type_health));
...
; 61   :   gdi->TextAtPos(Position+Vector2D(0,15), s);
...
; 50   :   pBot->GetBrain()->AddGoal_GetItem(type_health); 
...
; 14   :   double Distance = Raven_Feature::DistanceToItem(pBot, type_health);
...
; 31   :     double Desirability = Tweaker * (1-Raven_Feature::Health(pBot)) / 
...
$LN5@Clamp:
	push	178					; 000000b2H
	push	OFFSET ??_C@_1HM@PECBDNPB@?$AAD?$AA?3?$AA?2?$AAG?$AAi?$AAt?$AA?2?$AAG?$AAi?$AAt?$AAH?$AAu?$AAb?$AAP?$AAr?$AAo?$AAj?$AAe?$AAc?$AAt?$AA?2?$AAM?$AAi?$AAn?$AAi?$AA_?$AAP?$AAr?$AAo?$AAj?$AAe?$AAt@
